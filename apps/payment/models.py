...
class Refund(models.Model):
    ...
    def __str__(self):
        return (
            f'Refund {self.id} - ${self.amount} for Payment {self.payment.id}'
        )

    @property
    def is_partial(self):
        """Проверяе, является ли возврат частичным"""
...
class WebhookEvent(models.Model):
    ...
    class Meta:
        ...
        verbose_name = 'Weebhook Event'
        verbose_name_plural = 'Weebhook Events'
        ordering = ['-created_at']
        indexes = [
